...
def configureDisplayToMain():
    import Xlib.display
    import pyautogui
    pyautogui._pyautogui_x11._display = Xlib.display.Display(':1')


def loginAsGmailUser(username, password):
    humanMove(450, 50, 1)
    humanTyping('accounts.google.com/servicelogin')
